...
export class AparatosController {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAparatoDto: UpdateAparatoDto) {
    return this.aparatosService.update(+id, updateAparatoDto);
  }

  @Delete(':id')
  remove(@Param('id') id: string) {
    return this.aparatosService.remove(+id);
  }
}
